...
void measure_suite(std::filesystem::path path) {
	...
	use_algorithm<Log::Algorithm::SIMPLIFICATION_KLW_MANHATTAN, Simplification::simplification_klw_manhattan>(w_polylines, n_polylines, log, _epsilon);
	use_algorithm<Log::Algorithm::SIMPLIFICATION_KLW_CHEBYSHEV, Simplification::simplification_klw_chebyshev>(w_polylines, n_polylines, log, _epsilon);
	use_algorithm<Log::Algorithm::SIMPLIFICATION_KLW_EUCLIDEAN, Simplification::simplification_klw_euclidean>(w_polylines, n_polylines, log, _epsilon);
	use_algorithm<Log::Algorithm::SIMPLIFICATION_KLW_IMPLICIT_EUCLIDEAN, Simplification::simplification_klw_euclidean_implicit>(w_polylines, n_polylines, log, _epsilon);
	use_algorithm<Log::Algorithm::SIMPLIFICATION_KLW_SEMIEXPLICIT_EUCLIDEAN, Simplification::simplification_klw_euclidean_semiexplicit>(w_polylines, n_polylines, log, _epsilon2);


	use_algorithm<Log::Algorithm::SIMPLIFICATION_BC_MANHATTAN, Simplification::simplification_bc_manhattan_explicit>(w_polylines, n_polylines, log, _epsilon);
	use_algorithm<Log::Algorithm::SIMPLIFICATION_BC_CHEBYSHEV, Simplification::simplification_bc_chebyshev_explicit>(w_polylines, n_polylines, log, _epsilon);
	use_algorithm<Log::Algorithm::SIMPLIFICATION_BC_EUCLIDEAN, Simplification::simplification_bc_euclidean_explicit>(w_polylines, n_polylines, log, _epsilon);
	use_algorithm<Log::Algorithm::SIMPLIFICATION_BC_SEMIEXPLICIT_EUCLIDEAN, Simplification::simplification_bc_euclidean_semiexplicit>(w_polylines, n_polylines, log, _epsilon2);
}
