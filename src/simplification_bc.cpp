...
Simplification::Simplification Simplification::simplification_bc_euclidean_explicit(DataStructures::Polyline const &polyline, float epsilon, AlgorithmConfiguration &config) {
...
Simplification::Simplification Simplification::simplification_bc_manhattan_explicit(DataStructures::Polyline const &polyline, float epsilon, AlgorithmConfiguration &config) {
	auto time_start = std::chrono::high_resolution_clock::now();
...
Simplification::Simplification Simplification::simplification_bc_chebyshev_explicit(DataStructures::Polyline const &polyline, float epsilon, AlgorithmConfiguration &config) {
	auto time_start = std::chrono::high_resolution_clock::now();
...
Simplification::Simplification Simplification::simplification_bc_euclidean_semiexplicit(DataStructures::Polyline const &polyline, float epsilon, AlgorithmConfiguration &config) {
	auto time_start = std::chrono::high_resolution_clock::now();
