...
std::string algorithm_name(Algorithm algorithm) {
  switch (algorithm) {
  case Algorithm::SIMPLIFICATION_KLW_MANHATTAN:
    return "Manhattan Simplification (Simple)";
  case Algorithm::SIMPLIFICATION_KLW_EUCLIDEAN:
    return "Euclidean Simplification (Simple)";
  case Algorithm::SIMPLIFICATION_KLW_IMPLICIT_EUCLIDEAN:
    return "Euclidean Simplification (Simple, Implicit)";
  case Algorithm::SIMPLIFICATION_KLW_SEMIEXPLICIT_EUCLIDEAN:
    return "Euclidean Simplification (Simple, Semiexplicit)";
  case Algorithm::SIMPLIFICATION_KLW_CHEBYSHEV:
    return "Chebyshev Simplification (Simple)";
  case Algorithm::SIMPLIFICATION_KLW_IMPLICIT_MINKOWSKI:
    return "Minkowski Simplification (Simple, Implicit)";

  case Algorithm::SIMPLIFICATION_BC_MANHATTAN:
    return "Manhattan Simplification (Advanced)";
  case Algorithm::SIMPLIFICATION_BC_EUCLIDEAN:
    return "Euclidean Simplification (Advanced)";
  case Algorithm::SIMPLIFICATION_BC_IMPLICIT_EUCLIDEAN:
    return "Euclidean Simplification (Advanced, Implicit)";
  case Algorithm::SIMPLIFICATION_BC_SEMIEXPLICIT_EUCLIDEAN:
    return "Euclidean Simplification (Advanced, Semiexplicit)";
  case Algorithm::SIMPLIFICATION_BC_CHEBYSHEV:
    return "Chebyshev Simplification (Advanced)";
  case Algorithm::SIMPLIFICATION_BC_IMPLICIT_MINKOWSKI:
