...
Simplification simplification_klw_euclidean_implicit(Polyline const &polyline, float epsilon, AlgorithmConfiguration &config) {
...
Simplification simplification_klw_euclidean(Polyline const &polyline, float epsilon, AlgorithmConfiguration &config) {
...
Simplification simplification_klw_manhattan(Polyline const &polyline, float epsilon, AlgorithmConfiguration &config) {
...
Simplification simplification_klw_chebyshev(Polyline const &polyline, float epsilon, AlgorithmConfiguration &config) {
...
Simplification simplification_klw_euclidean_semiexplicit(Polyline const &polyline, float epsilon2, AlgorithmConfiguration &config) {
